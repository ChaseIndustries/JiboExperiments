    ...
    CloudChatTtsCoordinator? ttsCoordinator = null) : IConversationBroker
{
    ...
    private static bool ShouldKeepMicOpen(string? intentName)
    {
        return intentName switch
        {
            ...
            "proactive_pizza_day" => false,
            "proactive_pizza_preference" => false,
            "proactive_pizza_fact" => false,
            "proactive_fun_fact" => false,
            "proactive_joke" => false,
            "proactive_offer_declined" => false,
            "surprise" => false,
            "ha_lights_off" => false,
            "ha_lights_on" => false,
