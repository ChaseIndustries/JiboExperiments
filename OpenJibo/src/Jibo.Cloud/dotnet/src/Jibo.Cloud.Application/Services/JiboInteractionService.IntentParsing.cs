...
public sealed partial class JiboInteractionService
{
    ...
    private static bool IsPreferenceRecallAttempt(string loweredTranscript)
    {
        ...
        return TryExtractPreferenceLookupCategory(normalized) is not null ||
               ...
               normalized.StartsWith("do you happen to know my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("do you happen to recall my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you happen to recall my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("could you happen to recall my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("would you happen to recall my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("do you recall my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("do you happen to know my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("do you happen to recall my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you happen to recall my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("could you happen to recall my favourite", StringComparison.Ordinal) ||
               ...
               normalized.StartsWith("would you happen to recall my fave", StringComparison.Ordinal) ||
               ...
               normalized.StartsWith("remind me my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("remind me my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("remind me my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("remind me what my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("remind me what my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("remind me what my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("please remind me my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("please remind me my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("please remind me my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("please remind me what my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("please remind me what my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("please remind me what my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remind me my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remind me my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remind me my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remind me what my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remind me what my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remind me what my fave", StringComparison.Ordinal) ||
               ...
               normalized.StartsWith("what did i tell you my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("what did i tell you my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("what did i tell you my fave", StringComparison.Ordinal) ||
               ...
               normalized.StartsWith("have i mentioned my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("have i mentioned my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("have i mentioned my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("did i mention my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("did i mention my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("did i mention my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("what did i mention my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("what did i mention my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("what did i mention my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("do you remember that i said my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("do you remember that i said my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("do you remember that i said my fave", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remember that i told you my favorite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remember that i told you my favourite", StringComparison.Ordinal) ||
               normalized.StartsWith("can you remember that i told you my fave", StringComparison.Ordinal) ||
    ...
    private static string? TryExtractPreferenceLookupCategory(string transcript)
    {
        ...
        var prefixes = new[]
        {
            ...
            "would you happen to recall my favorite ",
            ...
            "remind me my favorite ",
            "please remind me my favorite ",
            "can you remind me my favorite ",
            ...
            "do you remember when i said my favorite ",
            "do you remember when i told you my favorite ",
            "can you remember me telling you my favorite ",
            "could you remember me telling you my favorite ",
            "would you remember me telling you my favorite ",
            "what have i told you my favorite ",
            "have i mentioned my favorite ",
            "did i mention my favorite ",
            "what did i mention my favorite ",
            ...
            "would you happen to recall my favourite ",
            ...
            "remind me my favourite ",
            "please remind me my favourite ",
            "can you remind me my favourite ",
            ...
            "do you remember when i said my favourite ",
            "do you remember when i told you my favourite ",
            "can you remember me telling you my favourite ",
            "could you remember me telling you my favourite ",
            "would you remember me telling you my favourite ",
            "what have i told you my favourite ",
            "have i mentioned my favourite ",
            "did i mention my favourite ",
            "what did i mention my favourite ",
            ...
            "would you happen to recall my fave ",
            ...
            "remind me my fave ",
            "please remind me my fave ",
            "can you remind me my fave ",
            ...
            "do you remember when i said my fave ",
            "do you remember when i told you my fave ",
            "can you remember me telling you my fave ",
            "could you remember me telling you my fave ",
            "would you remember me telling you my fave ",
            "what have i told you my fave ",
            "have i mentioned my fave ",
            "did i mention my fave ",
            "what did i mention my fave ",
        ...
        var embeddedLeads = new[]
        {
            ...
            "would you happen to recall what my",
            ...
            "do you remember when i said what my",
            "do you remember when i said my",
            "do you remember when i told you what my",
            "do you remember when i told you my",
            "can you remember me telling you what my",
            "can you remember me telling you my",
            "could you remember me telling you what my",
            "could you remember me telling you my",
            "would you remember me telling you what my",
            "would you remember me telling you my",
            "what have i told you my",
            "have i mentioned my",
            "did i mention my",
            "what did i mention my",
    ...
    {
        var normalized = NormalizeCommandPhrase(loweredTranscript);
        return MatchesAny(normalized, "show my alarm", "show my alarms", "show the alarm", "show the alarms",
                   "check my alarm", "check my alarms", "check the alarm", "check the alarms", "query my alarm",
                   "query the alarm", "alarm status", "alarm status please", "is my alarm set", "is an alarm set",
                   "is there an alarm", "are there any alarms", "do i have an alarm", "do you have an alarm") ||
               Regex.IsMatch(normalized, @"\b(?:when|what time)\b.*\balarm\b.*\b(?:ring|go off|activate)\b",
                   RegexOptions.IgnoreCase | RegexOptions.CultureInvariant) ||
               Regex.IsMatch(normalized, @"\bhow long\b.*\balarm\b", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant);
    }
